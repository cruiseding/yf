...
@WebServlet("/uiface/mA01201")
public class aipengServletInOut_01201  extends HttpServlet {

	
	private static final long serialVersionUID = -1204545408335287565L;


	public aipengServletInOut_01201() {
		super();
	}
...
//		arg = JsonUtil.jsonReceive(request);
	/*	if(arg[0].contains("user")){
		...
		try {
			...
			case "A-user-add":
				inOutFace = new aipengInoutUser_01201(arg, request, response);
				inOutFace.addface();
				break;
			case "A-user-mod":
				inOutFace = new aipengInoutUser_01201(arg, request, response);
